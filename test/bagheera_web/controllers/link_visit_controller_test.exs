defmodule BagheeraWeb.LinkVisitControllerTest do
  ...
  test "should return a 404 given an invalid hash", %{conn: conn} do
    assert_error_sent :not_found, fn ->
      get(conn, Routes.link_visit_path(conn, :show, "/bogus-hash!"))
    end
  end
end
